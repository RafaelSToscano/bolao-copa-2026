...
const podiumCards = [
  { title: "Líder", icon: "🏆", color: "text-yellow-400" },
  { title: "Vice-líder", icon: "🥈", color: "text-slate-300" },
  { title: "Terceiro", icon: "🥉", color: "text-orange-300" },
];
          ...
          return (
            ...
            >
              <CardContent className="p-2 md:p-5 text-center space-y-1 md:space-y-3">
                <div className="text-2xl md:text-5xl leading-none drop-shadow-lg">
                  {card.icon}
                </div>
